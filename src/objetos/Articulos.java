...
public class Articulos implements Facturar,Editables,Modificable{
    ...
    private String descripcionLista2;
    private Double lista3;
    private String descripcionLista3;
    private Double lista4;
    private String descripcionLista4;
    ...
    public Double getPrecioLista4() {
        return precioLista4;
    }

    public void setPrecioLista4(Double precioLista4) {
        this.precioLista4 = precioLista4;
    }
    ...
    public String getDescripcionLista2() {
        return descripcionLista2;
    }

    public void setDescripcionLista2(String descripcionLista2) {
        this.descripcionLista2 = descripcionLista2;
    }
    ...
    public String getDescripcionLista3() {
        return descripcionLista3;
    }

    public void setDescripcionLista3(String descripcionLista3) {
        this.descripcionLista3 = descripcionLista3;
    }
    ...
    public String getDescripcionLista4() {
        return descripcionLista4;
    }

    public void setDescripcionLista4(String descripcionLista4) {
        this.descripcionLista4 = descripcionLista4;
    }
    ...
    public static void CargarMap(){
        ...
        try {
            while(rr.next()){
                ...
                articulo.setDolar(rr.getDouble("dolar"));
                articulo.setLista2(rr.getDouble("lista2"));
                articulo.setLista3(rr.getDouble("lista3"));
                articulo.setLista4(rr.getDouble("lista4"));
                articulo.setPrecioLista1(rr.getDouble("pl1"));
                articulo.setPrecioLista2(rr.getDouble("pl2"));
                articulo.setPrecioLista3(rr.getDouble("pl3"));
                articulo.setPrecioLista4(rr.getDouble("pl4"));
                articulo.setPrecioCosto(rr.getDouble("pcto"));
        ...
        */ 
            sql="select articulos.ID,articulos.NOMBRE,articulos.BARRAS,articulos.recargo,articulos.PRECIO,articulos.equivalencia,articulos.COSTO,articulos.MINIMO,(articulos.STOCK) as stock,articulos.SERVICIO, articulos.modificaPrecio,articulos.modificaServicio,articulos.servicio1,articulos.dolar,articulos.lista2,articulos.lista3,articulos.lista4,round((articulos.dolar * articulos.PRECIO),2)as pl1,round((articulos.dolar * articulos.lista2),2)as pl2,round((articulos.dolar * articulos.lista3),2)as pl3,round((articulos.lista4 * articulos.dolar),2)as pl4,round((articulos.dolar * articulos.COSTO),2)as pcto from articulos where INHABILITADO=0 order by NOMBRE";
        //}
...
//                System.out.println(Inicio.sucursal.getDireccion());
        ...
        */
        ...
        switch (funcion){
            case 1:
                sql="select *,(0.00)as stock,round((articulos.dolar * articulos.PRECIO),2)as pl1,round((articulos.dolar * articulos.lista2),2)as pl2,round((articulos.dolar * articulos.lista3),2)as pl3,round((articulos.lista4 * articulos.dolar),2)as pl4,round((articulos.dolar * articulos.COSTO),2)as pcto from articulos where INHABILITADO=0 order by ID";
                break;
            case 2:
...
//            tra.guardarRegistro(sql);
    ...
    public Object cargarPorCodigoDeBarra(String codigoDeBarra) {
        ...
        String sql="select id,nombre,barras,precio,equivalencia,costo,minimo,stock,servicio,servicio1,modificaprecio,modificaservicio,stock,recargo,idcombo,articulos.dolar,articulos.lista2,articulos.lista3,articulos.lista4,round((articulos.dolar * articulos.PRECIO),2)as pl1,round((articulos.dolar * articulos.lista2),2)as pl2,round((articulos.dolar * articulos.lista3),2)as pl3,round((articulos.lista4 * articulos.dolar),2)as pl4,round((articulos.dolar * articulos.COSTO),2)as pcto from articulos where BARRAS like '"+codigoDeBarra+"' and INHABILITADO=0";
        rr=tra.leerConjuntoDeRegistros(sql);
        Articulos articulo=new Articulos();
    ...
    public Boolean AltaObjeto(Object objeto) {
        ...
        if(articulo.getModificaPrecio() !=null){
            ...
            articulo.setModificaPrecio(false);
    ...
    @Override
    public ArrayList listadoBusquedaMayorista(String criterio,Integer lista) {
        ArrayList resultado=new ArrayList();
        Articulos articulo=null;
        criterio=criterio.toUpperCase();
        String sql="select *,(select sum(cantidad) FROM movimientosarticulos where movimientosarticulos.idArticulo=articulos.ID group by idArticulo,numeroDeposito limit 0,1)as sstock,round((articulos.dolar * articulos.PRECIO),2)as pl1,round((articulos.dolar * articulos.lista2),2)as pl2,round((articulos.dolar * articulos.lista3),2)as pl3,round((articulos.lista4 * articulos.dolar),2)as pl4,round((articulos.dolar * articulos.COSTO),2)as pcto from articulos where nombre like '%"+criterio+"%'";
        ...
        try {
            while(rr.next()){
                ...
                switch (lista){
                    case 1:
                        articulo.setPrecioUnitarioNeto(rr.getDouble("PRECIO") * rr.getDouble("dolar"));
                        break;
                    case 2:
                        articulo.setPrecioUnitarioNeto(rr.getDouble("lista2") * rr.getDouble("dolar"));
                        break;
                    case 3:
                        articulo.setPrecioUnitarioNeto(rr.getDouble("lista3") * rr.getDouble("dolar"));
                        break;
                    case 4:
                        articulo.setPrecioUnitarioNeto(rr.getDouble("lista4") * rr.getDouble("dolar"));
                        break;
                    default:
                        articulo.setPrecioUnitarioNeto(rr.getDouble("PRECIO") * rr.getDouble("dolar"));
                        break;
    ...
    @Override
    public Object cargarPorCodigoDeBarraMayorista(String codigoDeBarra,Integer lista) {
        //Articulos articulo;
        //articulo=(Articulos)listadoBarr.get(codigoDeBarra);
